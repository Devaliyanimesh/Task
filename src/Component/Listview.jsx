...
let time = "Mon , 21 Dec 2020 14:25 GMT"
...
export default function Listview(props) {
  ...
  return (
    <div className='flex gap-2 items-center'>
      <div className='flex gap-[1.5rem] rounded-lg shadow-lg px-[1.5rem] py-[0.5rem] w-full bg-slate-300'>
        <img
       ...
       <div onClick={() => fun()} className="cursor-pointer">
